...
2. **Scope Boundaries**: Explicitly list files allowed for edit and non-goals to prevent scope creep.
3. **Machine Acceptance Criteria**: Provide unambiguous test benchmarks (e.g. status codes, performance limits, test coverage).
