...
function createSlide(pres, theme) {
  ...
  slide.addText('09:00 AM - 11:30 AM', {
    x: 7.2, y: 0.45, w: 2.2, h: 0.38,
  ...
  const itemsLeft = [
    '09:00 - 09:15 | Why Harness Engineering',
    '09:15 - 09:30 | Core Harness Stack & Architecture',
    '09:30 - 09:50 | Spec-Driven Development',
    '09:50 - 10:10 | Guardrails & Deterministic Hooks',
  ...
  const itemsRight = [
    '10:20 - 10:35 | Tests as Reliability Layer',
    '10:35 - 10:50 | Skills, Plugins, and MCP Tools',
    '10:50 - 11:05 | Compound Engineering & Agent Teams',
    '11:05 - 11:15 | Practical Workflow Pattern',
    '11:15 - 11:30 | Closing Principles and Q&A'
  ];
