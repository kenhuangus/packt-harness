...
'Production AI Coding Agent Systems Architecture'
)
slides_cnt += 1

# Slide 2: Master Course Map
make_cards('COURSE MASTER MAP & GITHUB REPOSITORY', '', [
{'title': 'PART 1: FOUNDATIONS & CONTROL ', 'bullets': [
'Mod 1: Why Harness Engineering & Failure Modes',
'Mod 2: Core Harness Stack & 5 System Pillars',
'Mod 3: Spec-Driven Development (SDD) & Schemas',
'Mod 4: Guardrails, AST Checks & Deterministic Hooks',
'Mod 5: Break & Permission Gateways Q&A'
]},
{'title': 'PART 2: RELIABILITY & TEAMS ', 'bullets': [
'Mod 5: Tests as Reliability Layer & TDA Loop',
'Mod 6: Skills, Plugins & Model Context Protocol (MCP)',
'Mod 7: Compound Engineering & Multi-Agent Swarms',
'Mod 8: 5-Step Practical Workflow SOP Pattern',
'Closing: Core Principles, Audit Checklist & GitHub Code'
]}
], slides_cnt + 1)
slides_cnt += 1
...
make_section(4, 'Guardrails and Deterministic Hooks', '', [
...
make_section(5, ' Break & Permission Gateways', '', [
...
make_section(10, 'Closing Principles & Production Audit', '', [
