...
# Slide 1: Cover
make_cover('Harness Engineering for AI Coding Agents', '60+ Slide Comprehensive Architectural Blueprint & Production Guide', '🕒 09:00 AM - 11:30 AM  |  🎯 Claude Code, AGY, MCP & Safety Guardrails  |  💡 62 Slides Deck')
slides_cnt += 1

# Slide 2: Master Course Map
make_cards('COURSE MASTER MAP & TIMETABLE', '09:00 AM - 11:30 AM', [
    {'title': 'PART 1: FOUNDATIONS & CONTROL (09:00 - 10:20)', 'bullets': [
        'Mod 1 (09:00-09:15): Why Harness Engineering & Agent Failure Modes',
        'Mod 2 (09:15-09:30): Core Harness Stack & 5 System Pillars',
        'Mod 3 (09:30-09:50): Spec-Driven Development (SDD) & Machine Specs',
        'Mod 4 (09:50-10:10): Guardrails & Deterministic Hooks (Pre/Post Controls)',
        'Break (10:10-10:20): Mid-Morning Break & Checkpoint Q&A'
    ]},
    {'title': 'PART 2: RELIABILITY & TEAMS (10:20 - 11:30)', 'bullets': [
        'Mod 5 (10:20-10:35): Tests as Reliability Layer & Test-Driven Agents',
        'Mod 6 (10:35-10:50): Skills, Plugins & Model Context Protocol (MCP)',
        'Mod 7 (10:50-11:05): Compound Engineering & Multi-Agent Teams',
        'Mod 8 (11:05-11:15): 5-Step Practical Workflow Pattern',
        'Closing (11:15-11:30): Core Principles, Checklist & Final Q&A'
    ]}
], slides_cnt + 1)
slides_cnt += 1
...
make_cards('The Paradigm Shift: Model vs System Harness', '09:00 AM - 09:15 AM', [
...
make_cards('The 98% Harness Rule', '09:00 AM - 09:15 AM', [
...
make_cards('Failure Mode 1: Context Drift & Amnesia', '09:00 AM - 09:15 AM', [
...
make_cards('Failure Mode 2: Infinite Execution Loops', '09:00 AM - 09:15 AM', [
...
make_cards('Failure Mode 3: Unsanitized Edits & Bad Tools', '09:00 AM - 09:15 AM', [
...
make_cards('System Architecture: The 5 Harness Pillars', '09:15 AM - 09:30 AM', [
...
make_cards('Pillar 1: Instructions & Repo Conventions', '09:15 AM - 09:30 AM', [
...
make_cards('Pillar 2: Scoped Tools & Permission Models', '09:15 AM - 09:30 AM', [
...
make_cards('Pillar 3: Deterministic Hooks & Policy Engine', '09:15 AM - 09:30 AM', [
...
make_cards('Pillars 4 & 5: Automated Testing & Observability', '09:15 AM - 09:30 AM', [
...
make_cards('Fundamentals of Spec-Driven Development', '09:30 AM - 09:50 AM', [
...
make_cards('Anatomy of an Executable SPEC.md', '09:30 AM - 09:50 AM', [
...
make_cards('Defining Scope Boundaries & Non-Goals', '09:30 AM - 09:50 AM', [
...
make_cards('Drafting Machine-Verifiable Acceptance Criteria', '09:30 AM - 09:50 AM', [
...
make_cards('How Claude Code & AGY Consume Specs', '09:30 AM - 09:50 AM', [
...
make_cards('Spec Verification & Anti-Hallucination', '09:30 AM - 09:50 AM', [
...
make_section(4, 'Guardrails & Deterministic Hooks', '09:50 AM - 10:10 AM', [
...
make_cards('Defense-in-Depth Control Architecture', '09:50 AM - 10:10 AM', [
...
make_cards('Pre-Action Hooks: Intercepting Commands', '09:50 AM - 10:10 AM', [
...
make_cards('Post-Action Checks: AST Parsers & Linters', '09:50 AM - 10:10 AM', [
...
make_cards('Filesystem Sandboxing & Boundary Isolation', '09:50 AM - 10:10 AM', [
...
make_cards('Admin Escalation & Permission Approval Gates', '09:50 AM - 10:10 AM', [
...
make_cards('Production Compliance & Auditability Matrix', '09:50 AM - 10:10 AM', [
...
make_section(5, 'Mid-Morning Break & Open Q&A', '10:10 AM - 10:20 AM', [
...
make_cards('Open Q&A & Group Discussion', '10:10 AM - 10:20 AM', [
...
make_cards('Test-Driven Agent (TDA) Architecture', '10:20 AM - 10:35 AM', [
...
make_cards('Multi-Tier Testing for AI Agents', '10:20 AM - 10:35 AM', [
...
make_cards('Automated Error Traceback Feedback Loops', '10:20 AM - 10:35 AM', [
...
make_cards('Turning Failures into Permanent Tests', '10:20 AM - 10:35 AM', [
...
make_cards('Mitigating Flaky Tests in Sandboxed Runs', '10:20 AM - 10:35 AM', [
...
make_cards('Test Reliability Scorecard & Metrics', '10:20 AM - 10:35 AM', [
...
make_cards('Agent Skills Open Standard (SKILL.md)', '10:35 AM - 10:50 AM', [
...
make_cards('Structuring Skill Instructions & Resources', '10:35 AM - 10:50 AM', [
...
make_cards('Plugin Bundles: Packaging Agent Capabilities', '10:35 AM - 10:50 AM', [
...
make_cards('Model Context Protocol (MCP) Foundation', '10:35 AM - 10:50 AM', [
...
make_cards('Connecting Agents to Enterprise APIs & DBs', '10:35 AM - 10:50 AM', [
...
make_cards('MCP Governance, Authentication & Security', '10:35 AM - 10:50 AM', [
...
make_cards('Multi-Agent Workflows vs Single Agents', '10:50 AM - 11:05 AM', [
...
make_cards('Role Specialization: The Planner Agent', '10:50 AM - 11:05 AM', [
...
make_cards('Role Specialization: The Implementer Agent', '10:50 AM - 11:05 AM', [
...
make_cards('Role Specialization: The Reviewer Agent', '10:50 AM - 11:05 AM', [
...
make_cards('Handoff Protocols & Context Passing', '10:50 AM - 11:05 AM', [
...
make_cards('Subagent Context, Tools & Worktree Isolation', '10:50 AM - 11:05 AM', [
...
make_cards('Building a Recursive Self-Improvement Loop', '10:50 AM - 11:05 AM', [
...
make_cards('The 5-Step Practical Workflow Overview', '11:05 AM - 11:15 AM', [
...
make_cards('Phases 1 & 2: Spec First & Constrained Exec', '11:05 AM - 11:15 AM', [
...
make_cards('Phases 3 & 4: Deterministic Checks & Tests', '11:05 AM - 11:15 AM', [
...
make_cards('Phase 5: Human Review & Sanity Auditing', '11:05 AM - 11:15 AM', [
...
make_section(10, 'Closing Principles & Final Q&A', '11:15 AM - 11:30 AM', [
...
make_cards('The 4 Core Principles of Harness Engineering', '11:15 AM - 11:30 AM', [
...
make_cards('Production Readiness Checklist', '11:15 AM - 11:30 AM', [
...
make_cards('The Future of Agentic Software Engineering', '11:15 AM - 11:30 AM', [
...
make_cards('Final Q&A, Wrap-Up & Workshop Takeaways', '11:15 AM - 11:30 AM', [
